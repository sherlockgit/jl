	...
	methods: {
        ...
        excle: function (event) {
            ...
            layer.confirm('确定要导出数据？', function (index) {
                window.location = baseURL + "sys/orderrefund/getExcle?orderNo=" + vm.q.orderNo + "&phone=" + vm.q.phone + "&userName=" + vm.q.userName + "&applyType=" + vm.q.applyType + "&refundStatus=" + vm.q.refundStatus+"&startTime="+vm.q.startTime+"&endTime="+vm.q.endTime;
                layer.close(index);
                vm.reload();
            });
